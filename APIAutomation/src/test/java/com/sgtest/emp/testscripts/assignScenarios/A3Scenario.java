...
//3. create employee --> display employee --> modify employee using put method -->
...
//          Create Request Body
    ...
    {
        try{
            System.out.println("This step deals with modify of Employee data in the database");
            RestAssured.baseURI="http://localhost:8082/sgtesting/api/v1/employees/"+employeeId;
            RequestSpecification httpRequest= RestAssured.given();
...
//            System.out.println("Employee Id : "+employeeId);
    ...
    public void displayModified_employee()
    {
        try
        {
            System.out.println("This step deals with display of modified Employee data from the database");
            RestAssured.baseURI="http://localhost:8082/sgtesting/api/v1/employees/"+employeeId;
            RequestSpecification httpRequest =RestAssured.given();
            //Specify the Header
            httpRequest.header("Content-Type","application/json");
    ...
    public void delete_employee()
    {
        try
        {
            System.out.println("This step deals with deletetion of  modified Employee data from the database");
            RestAssured.baseURI="http://localhost:8082/sgtesting/api/v1/employees/"+employeeId;
            RequestSpecification httpRequest =RestAssured.given();
            //Specify the Header
            httpRequest.header("Content-Type","application/json");
