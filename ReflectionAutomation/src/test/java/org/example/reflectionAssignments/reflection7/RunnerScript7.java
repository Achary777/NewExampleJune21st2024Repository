package org.example.reflectionAssignments.reflection7;
...
public class RunnerScript7 {
    ...
    private static void executeScripts()
    {
        ...
        try
        {
            fin=new FileInputStream("G:\\GitRepository1\\CurrentWorkSpace\\NewExampleJune21st2024Repository\\ReflectionAutomation\\testdata\\data_Runner7.xlsx");
