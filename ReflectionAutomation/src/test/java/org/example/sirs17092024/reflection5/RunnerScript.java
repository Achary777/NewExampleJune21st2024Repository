package org.example.sirs17092024.reflection5;
...
public class RunnerScript {
    ...
    private static void executeScripts()
    {
        ...
        try
        {
            fin=new FileInputStream("G:\\GitRepository1\\CurrentWorkSpace\\NewExampleJune21st2024Repository\\ReflectionAutomation\\testdata\\data_Runner.xlsx");
