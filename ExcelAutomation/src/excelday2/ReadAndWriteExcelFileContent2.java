...
public class ReadAndWriteExcelFileContent2 {
    ...
    private static void readWriteContent()
    {
        ...
        try
        {
            fin=new FileInputStream("D:\\Demo1\\EXCEL\\NewAdmission.xlsx");
            ...
            fout=new FileOutputStream("D:\\Demo1\\EXCEL\\NewAdmission.xlsx");
            wb.write(fout);
        }catch(Exception e)
        {
            e.printStackTrace();
